...
/**
 * Frontera transaccional del depósito (BR-004 — ADR-006, decisión 2 extendida
 * a SPEC-005): el use case (Java puro, sin Spring) corre dentro de esta
